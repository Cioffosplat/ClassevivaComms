...
<div id="mainPage" class="h-screen overflow-hidden bg-gray-200">
    ...
    <div id="cards" class="inline-flex w-screen my-10 place-content-center">
        <form action="comms.php" class="mr-10 ">
            <div class="bg-white shadow-lg rounded-lg p-6 space-y-4 ">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <div class="text-gray-900 text-2xl font-semibold " style="width: 300px">
                            71,897
                        </div>
                    </div>
                </div>
                <button type="submit" class="w-full text-purple-600 bg-purple-100 hover:bg-purple-200 text-sm py-2 px-4 rounded-md transition duration-300 ease-in-out">
                    Visualizza
                </button>
            </div>
        </form>
        <form action="comms.php" class="ml-10">
            <div class="bg-white shadow-lg rounded-lg p-6 space-y-4">
                <div class="flex items-center space-x-4">
                    <div class="p-2 bg-purple-200 rounded-full">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
...
if(!isset($_COOKIE['cookie_consent'])){
    echo '<div id="cookie-bannermain" class="cookie_banner fixed bottom-0 left-0 w-full bg-gray-900 text-white p-4" style="background-color: var(--theme0-accent2-color)">
        <div class="max-w-screen-lg mx-auto flex items-center justify-center space-x-3">
            ...
            <div class="flex space-x-3">
                <button onclick="acceptCookiesMain()" class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500">Accetta</button>
                <button onclick="rejectCookiesMain()" class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500">Rifiuta</button>
            </div>
        </div>
    </div>';
}

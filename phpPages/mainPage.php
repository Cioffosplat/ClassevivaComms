...
<div id="mainPage" class="h-screen overflow-hidden bg-gray-200">
    ...
    <div id="cards" class="flex flex-col sm:flex-row w-full mt-20 justify-center">
        ...
        <form action="star.php" class="w-full sm:w-1/3 mb-0 md:w-1/4 lg:w-1/4 mb-5 sm:mx-5">
        ...
        <form action="group.php" class="w-full sm:w-1/3 mb-0 md:w-1/4 lg:w-1/4 mb-5 sm:mx-5">

...
<div id="mainPage" class="h-screen overflow-auto bg-gray-200">
    ...
    <div id="communicationInfo" class="fixed inset-0 z-50 hidden flex justify-center items-center bg-gray-900 bg-opacity-50">
        <div id="communicationBanner" class="container mx-auto rounded-2xl p-6 h-3/4 w-3/4 flex flex-col justify-center items-center relative">
            ...
            <div id="successBanner" class="flex bg-green-100 rounded-lg p-4 mb-4 text-sm text-green-700 hidden" role="alert">
                <svg class="w-5 h-5 inline mr-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
                </svg>
                <div>
                    <span class="font-medium">Perfetto! </span>E' stata aggiunta la comunicazione ai tuoi preferiti!
                </div>
            </div>

    ...
    fetch('http://192.168.1.177/projects/ClassevivaComms/Fat3/user-stars', {
        ...
        .then(data => {
            data.forEach(communication => {
                ...
                titleCell.textContent = communication.name;
                titleCell.className = "px-6 py-4 whitespace-nowrap";
                row.appendChild(titleCell);

                var categoryCell = document.createElement("td");
                categoryCell.textContent = communication.category;
                categoryCell.className = "px-6 py-4 whitespace-nowrap"; // Aggiunto "=" mancante
